...
//$this->menu = array(
//TODO_BP : appartments list
//	                                                  array('label' => '<b>Краткоспрочная аренда</b>', 'icon' => 'icon-plus-sign', 'url' => $baseUrl . '/apartments/backend/main/create?type=1', 'active' =>  0),//isActive('apartments.create')
//                                                        array('label' => '<b>Долгострочная аренда</b>', 'icon' => 'icon-plus-sign',  'url' => $baseUrl . '/apartments/backend/main/create?type=2', 'active' => 0),
//                                                        array('label' => '<b>Продажа земли</b>', 'icon' => 'icon-plus-sign', 'url' => $baseUrl . '/apartments/backend/main/create?type=3', 'active' => 0),
//                                                        array('label' => '<b>Продажа виллы</b>','icon' => 'icon-plus-sign', 'url' => $baseUrl . '/apartments/backend/main/create?type=4', 'active' => 0),
//);
