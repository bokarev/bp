...
<?php endif; ?>
    ...
    <?php if(true){ //$model->canShowInForm('window_to') ?>
	<div class="rowold">
...
<?php if(true){ //$model->canShowInForm('num_of_rooms')?>
	<div class="rowold">
...
<?php if(true){ //$model->canShowInForm('num_of_pools') ?>
	<div class="rowold">
...
<?php } ?>
    ...
    <?php if(true){ //$model->canShowInForm('berths')?>
	<div class="rowold">
...
if (true) { //$model->canShowInForm('description')
    $this->widget('application.modules.lang.components.langFieldWidget', array(
        'model' => $model,
        'field' => 'description',
        'type' => 'text'
...
if (true) { // $model->canShowInForm('pool')
    $this->widget('application.modules.lang.components.langFieldWidget', array(
        'model' => $model,
        'field' => 'pool',
        'type' => 'text'
...
if (true) { //$model->canShowInForm('facilities')
    $this->widget('application.modules.lang.components.langFieldWidget', array(
        'model' => $model,
        'field' => 'facilities',
        'type' => 'text'
...
if (true) {//$model->canShowInForm('villascomplex')
    $this->widget('application.modules.lang.components.langFieldWidget', array(
        'model' => $model,
        'field' => 'villascomplex',
        'type' => 'text'
...
<?php if(true){//$model->canShowInForm('square')?>
    <div class="rowold">
...
<?php if(true){ //$model->canShowInForm('land_square') ?>
    <div class="rowold">
