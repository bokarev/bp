...
//        $this->_model->type = $type;
		if(isset($_POST[$this->modelName])){
			...
			if($isUpdate){
				...
				$this->_model->save(false);
                                $this->redirect(array('update', 'id' => $this->_model->id, 'type' => $this->_model->type));
...
;
	...
	public function actionCreate(){
		$model = new $this->modelName;
                ...
                // TODO_BP : die("actionCreate -> /Applications/XAMPP/xamppfiles/htdocs/dev/bp/protected/modules/apartments/controllers/backend/MainController.php");
		$model->save(false);

		$this->redirect(array('update', 'id' => $model->id,'type' => $model->type));
	}
